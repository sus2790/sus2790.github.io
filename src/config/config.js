...
export const config = {
    ...
    inviteUrl: "https://discord.com/api/oauth2/authorize?client_id=979969887554392104&permissions=8&scope=bot%20applications.commands",
    data: {
